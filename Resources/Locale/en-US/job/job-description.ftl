...
job-description-militech-chief = Lead the corporate detachment, manage restricted assets, and keep Militech priorities on track.
job-description-militech-operative-lead = Command the field team, coordinate response, and keep the squad alive.
job-description-militech-operative = Carry out security operations, enforce corporate interests, and survive the street.
job-description-militech-rigger = Coordinate drones, keep tactical hardware online, and extend the squad's reach without exposing the whole team.
job-description-militech-netrunner = Break hostile nodes, support the squad, and keep the network quiet.
job-description-militech-security-specialist = Provide armed protection for Militech personnel and controlled assets.
job-description-militech-combat-medic = Stabilize wounded personnel under fire and keep the team fighting.
job-description-militech-tech = Maintain corporate field equipment and keep it working under pressure.
job-description-militech-quartermaster = Track restricted supplies, issue gear, and keep the stockroom honest.
job-description-biotechnica-rigger = Operate remote platforms, maintain field interfaces, and keep Biotechnica assets working at a safe distance.
